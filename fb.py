...
def banner():
    ...
    runntxt(WW+"     ....       Yoga Wira")
    runntxt(GL+"                   BODO AMAT CUK")
    runntxt(GG+"     ..........     NGOPI DULU SANA")
    runntxt(Y+"    ............       GUNAKAN DENGAN BENAR")
    runntxt(GG+"           INGAT COK ")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   NEW TOOLS HACK FACEBOOK BF.   ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            AUTHOR BY: Yoga Wira             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |        TEAM : BROTHER CYBER HACKER            |"
    print Y+"  |             FACEBOOK: https://www.facebook.com/yoga.wira.188              |"
    print GL+"  |---------------------------------------------|"
